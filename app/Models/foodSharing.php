...
<?php
  ...
  if(isset($_POST["btn-upload"])){
    ...
    unset($_POST['btn-upload']);
    if(!empty($_POST['food-name-form']) && !empty($_POST['portion-form']) && !empty($_POST['note-form'])){
      ...
      if($error > 0){
        ...
        if($type == "image/png" || $type == "image/jpeg" || $type == "image/jpg"){
          ...
          $data = array(
              'username_pemberi' => $_SESSION['username'],
              'nama_makanan' => $_POST['food-name-form'],
              'porsi_makanan' => $_POST['portion-form'],
              'foto_makanan' => $name,
              'keterangan' => $_POST['note-form']
          );
          $food->add($data);
  ...
  //
    ...
    $Fdata = json_decode($food->readBy($_SESSION['username']));
    // print_r($Fdata); die();
  // $textName = explode(" ",$nm);
...
<head>
  ...
  <title>Food Sharing || ShareEat</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-cutlery" ></i> Food Sharing
        </div>
        <div class="card-body">

          <div class="container">
            <h2>Upload the food data</h2>
            <hr>
            <div class="row">
              <!-- left column -->
              <div class="col-md-3">
                <div class="text-center">
                  <!-- <img id="profileimg" src="uploads/defaultfood.png" class="avatar img-circle" alt="avatar">
              ...
              <div class="col-md-9 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="foodSharing.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="col-lg-3 control-label">Food name:</label>
                    <div class="col-lg-8">
                      <input name="food-name-form" class="form-control" type="text">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-lg-3 control-label">Username feeder:</label>
                    <div class="col-lg-8">
                      <input name="username-form" class="form-control" value="<?php echo $_SESSION['username'] ?>" type="text" disabled>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-lg-3 control-label">Portion:</label>
                    <div class="col-lg-8">
                      <input name="portion-form" class="form-control" type="text">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <textarea name="note-form" rows="7" cols="48"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="btn btn-primary" value="Upload" type="submit" name="btn-upload">
                      <span></span>
